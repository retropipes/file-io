    ...
    if (numRead > 0) {
      ...
      if (Character.isHighSurrogate(this.zzBuffer[this.zzEndRead - 1])) {
        if (numRead == requested) { // We requested too few chars to encode a full Unicode character
          ...
          int c = this.zzReader.read();  // Expecting to read a paired low surrogate char
          if (c == -1) {
            return true;
          } else {
    ...
    while (true) {
      ...
      zzForAction: {
        while (true) {
          ...
          int zzNext = zzTransL[ zzRowMapL[this.zzState] + zzCMap(zzInput) ];
      ...
      if (zzInput == YYEOF && this.zzStartRead == this.zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          case 1:
            { throw new JsonException(this.yychar, JsonException.Problems.UNEXPECTED_CHARACTER, yycharat(0));
            }
            // fall through
          case 24: break;
          case 2:
          ...
          case 25: break;
          case 3:
            { this.sb = null; this.sb = new StringBuilder(); yybegin(STRING_BEGIN);
            }
            // fall through
          case 26: break;
          case 4:
          ...
          case 34: break;
          case 12:
            { yybegin(YYINITIAL);return new Yytoken(Yytoken.Types.DATUM, this.sb.toString());
            }
            // fall through
          case 35: break;
          case 13:
